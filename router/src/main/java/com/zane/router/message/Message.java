...
public class Message implements Parcelable {
    ...
    public static class Url implements Parcelable {
        ...
        public Url(String scheme, String authority) {
            ...
            this.baseUrl = scheme + MessageBuilder.TAG_SCHEME_SUFFIX + authority;
        }
    ...
    private static String wrapString(Map<String, String> datas) {
        ...
        for (Map.Entry<String, String> entry : entrySet) {
            sb.append(entry.getKey())
                    .append(MessageBuilder.TAG_PARAMS_OPERATOR)
                    .append(entry.getValue())
                    .append(MessageBuilder.TAG_PARAMS_DIVIDER);
        }
        return sb.toString();
    }
...
//    }
    ...
    @Override
    public String toString() {
        return url.toString() + header.toString() + MessageBuilder.TAG_ADDRESS_SUFFIX + body.toString();
    }
